...
function EmployeeDetailPage() {
  ...
  // Formatea la fecha de ingreso (ISO → fecha legible)
  ...
  // Estado de carga — mismo spinner que EmployeesPage
  if (isLoading) {
    return (
  ...
  // Estado de error — mismo patrón que EmployeesPage
  if (isError) {
    return (
      <div className="p-6">
  ...
  // Si no hay empleado (id no existe)
